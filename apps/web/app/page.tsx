    ...
    <main>
      <section className="relative h-dvh flex justify-center items-center">
        <article className="relative flex justify-center items-center flex-col gap-15 p-10 max-w-dvw">
          ...
          <p className="sm:text-lg text-md font-light text-neutral-400 max-w-[50ch] text-center">
            A new way to apporach learning management system. Currently under
            development...
          </p>
        </article>
      </section>
      <section className="h-dvh bg-[url(/images/lmaos.jpg)] bg-center relative">
        <div className="custom-shape-divider-top-1781701400">
          <svg
            data-name="Layer 1"
